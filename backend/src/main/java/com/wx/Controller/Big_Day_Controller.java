...
public class Big_Day_Controller {
    ...
    @ResponseBody
    public Map<String, Object> bigday_build(Integer uid, String title,String date, String notes,Integer img)
    ...
    @ResponseBody
    public Map<String, Object> bigday_revise(Integer uid,Integer id, String title,String date, String notes,Integer img)
            throws  ParseException {
